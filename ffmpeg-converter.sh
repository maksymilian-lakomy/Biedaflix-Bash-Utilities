...
ffmpeg -i "$finalPath/1080.mp4" -vcodec libx264 -crf 21 -preset superfast -tune film -vf scale=1280:-1 "$finalPath/720.mp4"
ffmpeg -i "$finalPath/1080.mp4" -vcodec libx264 -crf 19 -preset superfast -tune film -vf scale=854:-1 "$finalPath/480.mp4"
